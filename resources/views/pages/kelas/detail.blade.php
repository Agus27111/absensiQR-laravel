        ...
        <div class="container-fluid">
            ...
            <div class="row">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($murid as $m)
                                        <tr>
                                            ...
                                            <td>{{ $m->kelas->kelas }}</td>
                                            <td>{{ $m->tahun->tahun }}</td>
                                            <td><a href="/detail-murid/{{ $m->id }}"><button
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data murid terlambat, tidak hadir, atau ijin kelas :
                                <b>{{ $kelas->kelas }}</b> | ({{ $hari }}, {{ $tanggal }})
                            </h3>
                            <div class="card-tools">
                                <div class="input-group input-group-sm" style="width: 100px;">
                                    {{-- <div class="input-group-append">
                            ...
                            <table id="absensiKelas" class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($absensi as $a)
                                        ...
                                        @elseif($a->status == 4 && $a->created_at->format('Y-m-d') == $verifikasiWaktu)
                                            <tr>
                                                <td class="table-light">{{ $noAbsensi++ }}</td>
                                                <td class="table-light">{{ $a->murid->nis }}</td>
                                                <td class="table-light">{{ $a->murid->nama }}</td>
                                                <td class="table-light">Hari Libur</td>
                                            </tr>
                                        @endif
                                    @endforeach
                                </tbody>
                    ...
                    <div class="modal-body mx-3">
                        <div class="md-form mb-0">
                            ...
                            <p class="text-danger"><i>Perhatian! Menghapus data kelas dapat menyebabkan <b>KERUSAKAN DATA
                                    ...
                                    pihak pengelola pada sekolah anda!. Jika anda sudah yakin akan tindakan anda, maka harap
                                    isi Captcha di bawah dan klik "Saya Yakin!"
                                    <br>
                                    <br>
